...
class ClassicBipedalBody extends WalkerAbstractBody {
     ...
     */
    constructor(scale, motors_torque=80, nb_steps_under_water=600, reset_on_hull_critical_contact=false, colors=null) {
    ...
    draw(world, init_x, init_y, force_to_center){
        ...
        // hull.color1 = "#806682"; // [0.5, 0.4, 0.9] Body fill
        // hull.color2 = "#4D4D80"; // [0.3, 0.3, 0.5] Body border
        hull.color1 = this.colors.hull_fill;
        hull.color2 = this.colors.hull_border;
        ...
        for(let i of [-1, +1]){
            ...
            leg.color1 = this.colors.leg_fill;
            leg.color2 = this.colors.leg_border;
            ...
            lower.color1 = this.colors.leg_fill;
            lower.color2 = this.colors.leg_border;
