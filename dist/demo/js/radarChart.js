      ...
      selection.each(function(data) {
        ...
        data.forEach(function(d){
          d.axes.forEach(function(axis, i) {
            ...
            if(axis.hasOwnProperty("maxValue")) {
              _maxValue = axis.maxValue;
            }
            axis.x = (cfg.w/2-radius2)+getHorizontalPosition(i, radius2, (parseFloat(Math.max(axis.value - cfg.minValue, 0))/_maxValue)*cfg.factor);
            axis.y = (cfg.h/2-radius2)+getVerticalPosition(i, radius2, (parseFloat(Math.max(axis.value - cfg.minValue, 0))/_maxValue)*cfg.factor);
          });
        });
